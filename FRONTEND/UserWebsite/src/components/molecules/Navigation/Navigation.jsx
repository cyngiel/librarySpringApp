...
<NavLink to='/'	className={({ isActive }) =>
				...
				<NavLink to='/user-reserved-book'	className={({ isActive }) =>
						isActive ? styles.active : styles.inactive
					}> Reserved books </NavLink>
				<NavLink to='/user-borrowed-book'	className={({ isActive }) =>
						isActive ? styles.active : styles.inactive
...
export const Navigation = () => {
	...
	return (
		<nav className={styles.navMenuWrapper}>
			...
			{userStatus ? <AuthenticatedApp /> : <UnauthenticatedApp />}
